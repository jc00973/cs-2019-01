...
public class DiaDaSemanaController {
    ...
    @RequestMapping("diferencaDatas")
    public DiaDaSemana diferencaDatas(@RequestParam(value="dataInicial", defaultValue = "não fornecida") String dataInicial,
                                   @RequestParam(value="dataFinal", defaultValue = "não fornecida" String dataFinal)) {
